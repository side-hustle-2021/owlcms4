    ...
    @Override
     protected void bindGridFields(CrudOperation operation) {
        ...
        binder.forField(snatch1Change1)
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateChangeForAttempt(1, getEditedAthlete())))
                ...
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange1(1, v, getEditedAthlete())))
        ...
        binder.forField(snatch1Change2)
                ...
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange2(1, v, getEditedAthlete())))
        ...
        binder.forField(snatch2Change1)
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateChangeForAttempt(2, getEditedAthlete())))
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateNextAthleteChangeTime(v, getEditedAthlete())))
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange1(2, v, getEditedAthlete())))
        ...
        binder.forField(snatch2Change2)
                ...
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange2(2, v, getEditedAthlete())))
        ...
        binder.forField(snatch3Change1)
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateChangeForAttempt(3, getEditedAthlete())))
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateNextAthleteChangeTime(v, getEditedAthlete())))
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange1(3, v, getEditedAthlete())))
        ...
        binder.forField(snatch3Change2)
                ...
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange2(3, v, getEditedAthlete())))
        ...
        binder.forField(cj1Change1)
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateChangeForAttempt(4, getEditedAthlete())))
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateNextAthleteChangeTime(v, getEditedAthlete())))
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange1(4, v, getEditedAthlete())))
                .withValidator(
        ...
        binder.forField(cj1Change2)
                ...
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange2(4, v, getEditedAthlete())))
                .withValidator(
        ...
        binder.forField(cj2Change1)
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateChangeForAttempt(5, getEditedAthlete())))
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateNextAthleteChangeTime(v, getEditedAthlete())))
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange1(5, v, getEditedAthlete())))
                .withValidator(
        ...
        binder.forField(cj2Change2)
                ...
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange2(5, v, getEditedAthlete())))
                .withValidator(
        ...
        binder.forField(cj3Change1)
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateChangeForAttempt(6, getEditedAthlete())))
                .withValidator(ValidationUtils.checkUsingException(v -> AthleteCardRules.validateNextAthleteChangeTime(v, getEditedAthlete())))
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange1(6, v, getEditedAthlete())))
                .withValidator(
        ...
        binder.forField(cj3Change2)
                ...
                .withValidator(
                    ValidationUtils.checkUsingException(v -> AthleteCardRules.validateWobRule(v, getEditedAthlete())))
                .withValidator(
                        ValidationUtils.checkUsingException(v -> AthleteCardRules.validateDistinctChange2(6, v, getEditedAthlete())))
                .withValidator(
