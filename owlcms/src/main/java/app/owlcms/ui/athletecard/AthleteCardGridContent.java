...
public abstract class AthleteCardGridContent extends VerticalLayout
        implements CrudListener<Athlete>, OwlcmsContent, QueryParameterReader, UIEventProcessor, IAthleteEditing {

    final private static Logger logger = (Logger) LoggerFactory.getLogger(AthleteCardGridContent.class);
...
//                    }
     ...
     */
    private AthleteCardDedicatedFormFactory getAthleteEditingFormFactory() {
        return athleteEditingFormFactory;
    }
