...
@Route("customactivate")
@SuppressWarnings("serial")
public class CustomActivationView extends Composite implements BeforeEnterObserver {

    private VerticalLayout layout;

    private final AuthService authService;

    public CustomActivationView(AuthService authService) {
